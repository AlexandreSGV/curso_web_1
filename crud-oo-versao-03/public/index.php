...
$aluno_id = isset($_GET['aluno_id']) ? $_GET['aluno_id'] : 0;
$turma_id = isset($_GET['turma_id']) ? $_GET['turma_id'] : 0;
...
// Actions de turma
    ...
    case 'list-turmas':
        ...
        break;
    case 'matricular_v1':
        $result = $turmaController->matricular_v1();
        break;
    case 'matricular_v2':
        $result = $turmaController->matricular_v2();
        break;
    case 'desmatricular':
        $turmaController->desmatricular($aluno_id, $turma_id);
        break;
