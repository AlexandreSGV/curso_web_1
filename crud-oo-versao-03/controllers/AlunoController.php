...
class AlunoController {
    ...
    public function read($id) {
        ...
        $this->alunoTurma->aluno_id = $id;
        $statement = $this->alunoTurma->listarTurmasDoAluno();
        $turmas = $statement->fetchAll(PDO::FETCH_ASSOC);
        return ['view' => '../views/aluno/read.php', 'data' => ['aluno' => $this->aluno, 'turmas' => $turmas]]; // Retorna a view e os dados do aluno e turmas em que esta matriculado
    }
    ...
    public function edit($id) {
        if ($_SERVER['REQUEST_METHOD'] === 'POST') { // Verifica se o método de requisição é POST
            ...
            // Chama o método edit() da classe Aluno para atualizar o aluno no banco de dados
            if ($this->aluno->edit()) {
